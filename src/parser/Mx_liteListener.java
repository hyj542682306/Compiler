...
public interface Mx_liteListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLambdaExpr(Mx_liteParser.LambdaExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lambdaExpr}
	 * labeled alternative in {@link Mx_liteParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitLambdaExpr(Mx_liteParser.LambdaExprContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterErrorCrea(Mx_liteParser.ErrorCreaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code errorCrea}
	 * labeled alternative in {@link Mx_liteParser#creator}.
	 * @param ctx the parse tree
	 */
	void exitErrorCrea(Mx_liteParser.ErrorCreaContext ctx);
	/**
	 * Enter a parse tree produced by the {@code arrayCrea}
	 * labeled alternative in {@link Mx_liteParser#creator}.
	 * @param ctx the parse tree
	 */
	void enterArrayCrea(Mx_liteParser.ArrayCreaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code arrayCrea}
	 * labeled alternative in {@link Mx_liteParser#creator}.
	 * @param ctx the parse tree
	 */
	void exitArrayCrea(Mx_liteParser.ArrayCreaContext ctx);
	/**
	 * Enter a parse tree produced by the {@code classCrea}
	 * labeled alternative in {@link Mx_liteParser#creator}.
	 * @param ctx the parse tree
	 */
	void enterClassCrea(Mx_liteParser.ClassCreaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code classCrea}
	 * labeled alternative in {@link Mx_liteParser#creator}.
	 * @param ctx the parse tree
	 */
	void exitClassCrea(Mx_liteParser.ClassCreaContext ctx);
	/**
	 * Enter a parse tree produced by the {@code basicCrea}
	 * labeled alternative in {@link Mx_liteParser#creator}.
	 * @param ctx the parse tree
	 */
	void enterBasicCrea(Mx_liteParser.BasicCreaContext ctx);
	/**
	 * Exit a parse tree produced by the {@code basicCrea}
	 * labeled alternative in {@link Mx_liteParser#creator}.
	 * @param ctx the parse tree
	 */
	void exitBasicCrea(Mx_liteParser.BasicCreaContext ctx);
	/**
	 * Enter a parse tree produced by {@link Mx_liteParser#lambda}.
	 * @param ctx the parse tree
	 */
	void enterLambda(Mx_liteParser.LambdaContext ctx);
	/**
	 * Exit a parse tree produced by {@link Mx_liteParser#lambda}.
	 * @param ctx the parse tree
	 */
	void exitLambda(Mx_liteParser.LambdaContext ctx);
}